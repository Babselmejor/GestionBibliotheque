...
public class AjoutEssai extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Ajouter un nouvel Livre essai");
    ...
    String theme = jTextField7.getText();

    // Créer un nouvel essai avec les informations récupérées
    Essai nouvelEssai = new Essai(titre, auteur, anneePublication, ISBN, theme);

    // Ajouter le nouvel essai à la bibliothèque
    Bibliotheque.ajouterLivre(nouvelEssai);

    // Afficher un message de confirmation
    JOptionPane.showMessageDialog(this, "Essai ajouté avec succès.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AjoutEssai.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AjoutEssai().setVisible(true);
            }
        });
    }
